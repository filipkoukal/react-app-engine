...
import { CreateUpdateDialog, CreateUpdateDialogProps } from '../components/createUpdateDialog';
    ...
    <Box display="flex" flexDirection="column">
      <Box display="flex" justifyContent="flex-end">
        <Button
          ...
          variant="contained"
          color="success"
          onClick={() => dialogRef.current?.handleClickOpen('Add new GPU', 'new')}
        >
          Add
        </Button>
      </Box>
      <Grid deleteEvent={openDeleteDialog} updateEvent={openUpdateDialog} />
